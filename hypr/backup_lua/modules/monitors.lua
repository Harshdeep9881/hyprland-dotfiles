...
-- Added both eDP-1 and eDP-2 to support hybrid graphics monitor naming,
-- along with a fallback rule for any connected display to prevent a black screen.
hl.monitor({ output = "eDP-1", mode = "1366x768@60", position = "0x0", scale = 1 })
hl.monitor({ output = "eDP-2", mode = "1366x768@60", position = "0x0", scale = 1 })
